(() => {
    ...
    function initSliders() {
        if (document.querySelector(".cashback__slider")) new swiper_core_Swiper(".cashback__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".cashback-pagination",
                clickable: true
            },
            on: {}
        });
    }
    function initSlidersaFounders(thumbsSlider) {
        if (document.querySelector(".a-founders__slider-text")) new swiper_core_Swiper(".a-founders__slider-text", {
            ...
            navigation: {
                nextEl: ".a-founders__slider-text-button-next",
                prevEl: ".a-founders__slider-text-button-prev"
            },
            on: {}
        });
    }
    function initSlidersaFoundersFoto() {
        if (document.querySelector(".a-founders__slider-foto")) return new swiper_core_Swiper(".a-founders__slider-foto", {
            modules: [ Navigation, Pagination, Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    window.addEventListener("load", (function(e) {
        initSliders();
        const thumbsSlider = initSlidersaFoundersFoto();
        initSlidersaFounders(thumbsSlider);
    }));
    class ScrollWatcher {
        constructor(props) {
            let defaultConfig = {
